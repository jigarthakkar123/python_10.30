...
insert=Button(root,text="INSERT",fg="white",bg="black",font=("Arial",12),command=insert_data)
insert.place(x=10,y=300)

search=Button(root,text="SEARCH",fg="white",bg="black",font=("Arial",12),command=search_data)
search.place(x=80,y=300)

update=Button(root,text="UPDATE",fg="white",bg="black",font=("Arial",12),command=update_data)
update.place(x=161,y=300)

delete=Button(root,text="DELETE",fg="white",bg="black",font=("Arial",12),command=delete_data)
